function [DCM_ll_I, omega_el_L, omega_ie_L] = lclevupd_corrected(lat1,lat2,vx1,vx2,vy1,vy2,...
...
DCM_ll_I=eulr2dcm(ang_vect); % 23 Septemebr 2020 exact transform instead of approximation
return;
